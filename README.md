...
To create a simple TODO application using AWS Lambda and Serverless framework.

### Course details -

Given a frontend we were tasked to create a somewhat basic Todo App using the Serverless framework, AWS Lambda functions, AWS API Gateway, S3, DynamoDB and Auth0.
